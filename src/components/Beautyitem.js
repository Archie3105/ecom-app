                            ...
                            <div className="col-md-4 col-12">
                                <div className="single_product shadow text-center p-1">
                                    <div className="product_img">
                                        <Link to="/beaitemdetails"><img
                                            src="./assets/images/beaitem1.png" className="img img-fluid"
                                            alt="" /></Link>
                                    </div>
                                    <div className="product-caption my-3">
                                        ...
                                        <h4>Multi Color Lipstick </h4>
                                        <h5><Link to="/beaitemdetails">For More Details</Link></h5>
                                        <div className="price">
...
mb-small-5">
                                    <div className="product_img">
                                        <Link to="/beaitemdetails"><img
                                            src="assets/images/beaitem2.png" className="img img-fluid"
                                            alt="" /></Link>
              ...
              color: "red"}}>New</span>
                            ...
                            <div className="col-md-4 col-12">
                                <div className="single_product shadow text-center p-1">
                                    <div className="product_img">
                                        <Link to="/beaitemdetails"><img
                                            src="assets/images/beaitem3.png" className="img img-fluid"
                                            alt="" /></Link>
                                        <div className="new_product">
                                            <span className="badge py-2 px-3 badge-pill
badge-danger" style={{
                        ...
                        <div className="row">
                            <div className="col-md-4 col-12">
                                <div className="single_product shadow text-center p-1">
                                    <div className="product_img">
                                        <Link to="/beaitemdetails"><img
                                            src="assets/images/beaitem4.png" className="img img-fluid"
                                            alt="" /></Link>
                                        <div className="new_product">
                                            <span className="badge py-2 px-3 badge-pill
badge-danger" style={{
...
mb-small-5">
                                    <div className="product_img">
                                        <Link to="/beaitemdetails"><img
                                            src="assets/images/beaitem5.png" className="img img-fluid"
                                            alt="" /></Link>
                                        <div className="new_product">
                                            <span className="badge py-2 px-3 badge-pill
badge-danger" style={{
              color: "red"}}>New</span>
                            ...
                            <div className="col-md-4 col-12">
                                <div className="single_product shadow text-center p-1">
                                    <div className="product_img">
                                        <Link to="/beaitemdetails"><img
                                            src="./assets/images/beaitem6.png" className="img img-fluid"
                                            alt="" /></Link>
                                    </div>
                                    <div className="product-caption my-3">
                                        <div className="product-ratting">
