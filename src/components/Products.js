                                ...
                                <div className="single_product shadow text-center p-1">
                                    <div className="product_img">
                                        <Link to="/productdetails"><img
                                            src="./assets/images/product1.webp" className="img img-fluid"
                                            alt="" /></Link>
                                    </div>
                                    <div className="product-caption my-3">
                                        ...
                                        <h4>Itachi White Dress </h4>
                                        <h5><Link to="/productdetails">For More Details</Link></h5>
                                        <div className="price">
...
mb-small-5">
                                    <div className="product_img">
                                        <Link to="/productdetails"><img
                                            src="assets/images/product2.png" className="img img-fluid"
                                            alt="" /></Link>
              ...
              color: "red"}}>New</span>
                            ...
                            <div className="col-md-4 col-12">
                                <div className="single_product shadow text-center p-1">
                                    <div className="product_img">
                                        <Link to="/productdetails"><img
                                            src="assets/images/product3.png" className="img img-fluid"
                                            alt="" /></Link>
                                        <div className="new_product">
                                            <span className="badge py-2 px-3 badge-pill
badge-danger" style={{
